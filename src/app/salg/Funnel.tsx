...
export function Funnel() {
  ...
  return (
    <div className="space-y-10 max-w-3xl mx-auto">
      <div className="bg-white rounded-3xl shadow-[0_4px_16px_-4px_rgba(0,0,0,0.08),0_24px_48px_-12px_rgba(0,0,0,0.12)] p-6 sm:p-10 space-y-8">
  ...
  return (
    ...
    >
          ...
          return (
            <div
              ...
              className={`flex-1 h-1 rounded-full transition-colors duration-300 ${
                isDone || isActive ? 'bg-brand-700' : 'bg-stone-200'
              }`}
            />
          );
        })}
      ...
      <div className="flex justify-between text-xs text-muted font-medium">
        ...
        <span className="sm:hidden text-brand-700 font-semibold">
